...
let draftKey = null, restoring = false, suppressHistory = false, lastView = null;
...
window.addEventListener('popstate', e => { suppressHistory = true; showView(e.state?.view || 'home'); setTimeout(() => suppressHistory = false, 0); });
